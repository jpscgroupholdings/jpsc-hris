...
const EvaluationSchema = new Schema<Evaluation>({
  ...
  dependatbility: { type: Number, required: true },
  ...
  optionalCompentencyRemarks: { type: String, trim: true },

  leadership: { type: Number, require: true },
  leadershipRemarks: {
    type: String,
    trim: true,
    required: true,
  ...
  subordinatesDevelopment: { type: Number, require: true },
